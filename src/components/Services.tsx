  ...
  const services = [
    {
      ...
      description:
        "Apoio personalizado para alunos do ensino básico em todas as disciplinas.",
    },
    {
      icon: <GraduationCap className="w-8 h-8" />,
      title: "Explicações do Ensino Secundário",
      description:
        "Preparação especializada para o ensino secundário e exames nacionais.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Explicações do Ensino Superior",
      description:
        "Apoio universitário com professores especializados em cada área.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Formação em informática desde iniciação até níveis avançados.",
    },
    // {
