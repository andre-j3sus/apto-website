      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Preços transparentes e justos para todos os nossos serviços educativos. 
            Todos os pagamentos devem ser feitos de forma prévia.
          </p>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 shadow-card">
          ...
          <ul className="space-y-2 text-muted-foreground">
            <li className="flex items-start gap-2">
              ...
              <span>Horário para Sala de Estudo (até ao 7º ano): Manhã das 9h às 13h e Tarde das 15h às 18h30/19h.</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-success-green mt-1 flex-shrink-0" />
              <span>Pagamento em numerário tem 10€ de desconto para pacotes mensais.</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-success-green mt-1 flex-shrink-0" />
